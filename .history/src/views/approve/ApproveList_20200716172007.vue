<template>
  <div>
        <div class="title-out">
      <div class="title-in" v-if="baseInfo.billId">消息列表</div>
    ...
    <el-tabs >
      <el-tab-pane label="待办未读" name="first">
        <el-table :data="todoList" stripe style="width: 100%">
          ...
          <el-table-column prop="messageContent" label="消息" width="180"></el-table-column>
        </el-table>
      ...
      <el-tab-pane label="待办已读" name="second">
        <el-table :data="todoListAl" stripe style="width: 100%">
          <el-table-column prop="createDate" label="日期" width="180"></el-table-column>
          <el-table-column prop="messageContent" label="消息" width="180"></el-table-column>
        </el-table>
      </el-tab-pane>
      ...
      <el-tab-pane label="通知已读" name="fourth">
        <el-table :data="noteListAl" stripe style="width: 100%">
          <el-table-column prop="createDate" label="日期" width="180"></el-table-column>
          <el-table-column prop="messageContent" label="消息" width="180"></el-table-column>
        </el-table>
      </el-tab-pane>
...
export default {
  ...
  created: function() {
    this.loadData("todoList", "2", "1", "0", "");
    this.loadData("todoListAl", "2", "1", "1", "");
    this.loadData("noteList", "4", "1", "0", "");
    this.loadData("noteListAl", "4", "1", "1", "");
  },
  methods: {
