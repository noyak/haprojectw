<template>
  <div class="box">
    ...
    <el-tabs type="card" v-if="headerArray.length>1">
      <el-tab-pane :label="body.tabname" v-for="(body,bindexs) in headerArray" :key="bindexs">
        <el-form :inline="true" :disabled="true" class="demo-form-inline form-dl" label-width="130px">
          <el-form-item :label="item.name" v-for="(item,index) in body.cols" v-bind:key="index" :data-title="item.name">
    ...
    <el-form :inline="true" :disabled="true" class="demo-form-inline form-dl" label-width="130px" v-if="headerArray.length==1">
      <el-form-item :label="item.name" v-for="(item,index) in headerArray[0].cols" v-bind:key="index" :data-title="item.name">
        <div class="label-tips">{{item.name}}</div>
        <el-input v-model="item.value"></el-input>
      </el-form-item>
    </el-form>
